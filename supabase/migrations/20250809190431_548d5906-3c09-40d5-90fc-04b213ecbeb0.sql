...
SET office_location = CASE 
  WHEN role = 'office_guwahati' THEN 'Guwahati'
  WHEN role = 'office_delhi' THEN 'Delhi'
  WHEN role = 'office_mumbai' THEN 'Mumbai'
  WHEN role = 'office_bangalore' THEN 'Bangalore'
  WHEN role = 'office_kolkata' THEN 'Kolkata'
  ELSE NULL
END
WHERE role LIKE 'office_%';
