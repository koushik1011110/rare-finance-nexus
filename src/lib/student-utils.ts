...
export const buildStudentInsertPayload = (formData: ComprehensiveStudentFormData, opts?: { defaultCourseId?: number | undefined; defaultSessionId?: number | undefined; forceStatus?: string; agentId?: number | null }) => {
  ...
  [
    'admission_number','city','country','address','aadhaar_number','passport_number','scores','twelfth_marks','photo_url','passport_copy_url','aadhaar_copy_url','twelfth_certificate_url','neet_score_card_url','tenth_marksheet_url','affidavit_paper_url','admission_letter_url','parents_phone_number','tenth_passing_year','twelfth_passing_year','neet_passing_year','tenth_marksheet_number','pcb_average','neet_roll_number','qualification_status','semester','country_id'
